    ...
    public class PaymentService : IPaymentService
    {
      //  private readonly IBasketRepository _basketRepository;
        ...
        public async Task<CustomerBasket> CreateOrUpdatePaymentIntent(string basketId)
        {
           ...
           var apiPathBasket = _config.GetSection("APIPaths:BasketService").Value + "?id=" + basketId;
           var basket = await InvokeBasketService.GetCustomerBasketAsync(apiPathBasket);
           ...
           await InvokeBasketService.UpdateCustomerBasketAsync(_config.GetSection("APIPaths:BasketService").Value, basket);
